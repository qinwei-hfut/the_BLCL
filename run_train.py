...
def run_exp(trainer,arch,batch_size,dataset,noise_type,noise_rate,gpu,optim,meta_optim,\
        ...
        finetune_criterion,extra,meta_batch_size,minuend_path,val_type):
...
# train_criterion = '\'{"type":"Mixed_loss_A","args":{"alpha_ce":0.0,"alpha_rce":0.0,"alpha_mae":0.0,"alpha_mse":0.0,"activation_type":"Sigmoid"}}\''
