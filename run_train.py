...
run_exp(trainer='meta_trainer',arch=arch,batch_size=128,optim=optim,meta_optim=meta_optim,lr_scheduler=lr_scheduler,meta_lr_scheduler=meta_lr_scheduler,noise_type='sym',noise_rate=0.9,epochs=250, dataset='cifar10', train_criterion=train_criterion,val_criterion=val_criterion,gpu=gpu)
