...
run_exp(trainer='trainer',arch='PreActResNet18',batch_size=128, lr=0.1,noise_type='asym',noise_rate=0.9,gpu=gpu,lr_schedule='80_120',train_criterion='MAE_loss',epochs=150)
